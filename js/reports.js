import { getUserRole, fetchData } from './common.js';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchReportsFromApi() {
        try {
            const response = await fetch('https://wisapi-latest.onrender.com/api/Reports/Get-All-Reports');
            if (!response.ok) {
    ...
    async function createTaskFromReport(reportId, title, dueDate, authorityId) {
        try {
            const response = await fetch(`https://wisapi-latest.onrender.com/api/Reports/${reportId}/Report-To-Task`, {
                method: 'POST',
                headers: {
